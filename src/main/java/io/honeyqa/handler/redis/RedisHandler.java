...
public class RedisHandler extends JedisTestBase {
    ...
    public void checkCloseableConnections() throws Exception {
        ...
        jedis.auth("honeybared");
        jedis.set("honey", "bar");
        assertEquals("bar", jedis.get("honey"));
        jedis.close();
        pool.close();
    ...
    public void ensureSafeTwiceFailover() throws InterruptedException {
        JedisSentinelPool pool = new JedisSentinelPool(MASTER_NAME, sentinels,
                new GenericObjectPoolConfig(), 1000, "honeybared", 2);
    ...
    public void customClientName() {
        ...
        config.setBlockWhenExhausted(false);
        JedisSentinelPool pool = new JedisSentinelPool(MASTER_NAME, sentinels, config, 1000,
                "honeybared", 0, "my_shiny_client_name");
    ...
    private void forceFailover(JedisSentinelPool pool) throws InterruptedException {
        ...
        assertEquals("honeybared", afterFailoverJedis.configGet("requirepass").get(1));
